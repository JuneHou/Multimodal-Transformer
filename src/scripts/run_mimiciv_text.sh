...
python -W ignore ./src/scripts/main_mimiciv.py  --num_train_epochs 8  --modeltype 'Text' \
                --kernel_size 1 --train_batch_size 2 --eval_batch_size 8 --seed 24 \
                ...
                --output_dir "/data/wang/junh/results/Fuse_moe/all_los/multiclass/final/unimodal/" \
                --embed_dim 128 \
                --num_modalities 1 \
