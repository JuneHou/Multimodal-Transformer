...
python -W ignore ./src/scripts/main_mimiciv_.py  --num_train_epochs 8  --modeltype 'TS_CXR_Text' \
                ...
                --file_path '/data/wang/junh/datasets/multimodal/multiclass/dynamic_weights_test_missing/'\
                --num_labels 4 \
                --num_heads 8 \
                --embed_time 64 \
                --tt_max 48 \
