...
python -W ignore ./src/scripts/main_mimiciv_.py  --num_train_epochs 8  --modeltype 'TS_CXR_Text_ECG' \
                ...
                --output_dir "/data/wang/junh/results/Fuse_moe/all_los/multiclass/missingInd/inverse_weighted/" \
                --embed_dim 128 \
                --num_modalities 4 \
                --model_name "bioLongformer"\
                --task 'los-48-cxr-notes-ecg-missingInd'\
                --file_path '/data/wang/junh/datasets/multimodal/multiclass/inverse_weights/'\
                --num_labels 4 \
                --num_heads 8 \
                --embed_time 64 \
                --tt_max 48 \
